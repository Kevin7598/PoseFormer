...
def listdir_no_dsstore(directory):
    """Returns a list of filenames in the directory, excluding .DS_Store."""
    return [f for f in os.listdir(directory) if f != '.DS_Store' and not f.startswith('.')]

def main(dataPath, saveDataPath):
    fileTypes = sorted(listdir_no_dsstore(dataPath))
...
if __name__ == '__main__':
    dataPath = "/Users/kaiqizhu/Desktop/CE-CSL/video"
    saveDataPath = "/Users/kaiqizhu/Desktop/CE-CSL/video2"
